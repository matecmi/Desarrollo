          ...
          <div class="col-6 col-8 col-lg-6 bg-primary-gradient bg-offcanvas-right">
            <div class="p-3 py-7 p-md-7">
              ...
              <div class="mt-6"><a href="<?= FACEBOOK ?>"> <img class="me-3"
                    src="<?= media();?>/landing/assets/img/icons/facebook.svg" alt="..." /></a><a
                  href="<?= INSTAGRAM ?>"> <img class="me-3" src="<?= media();?>/landing/assets/img/icons/twitter.svg"
                    alt="..." /></a><a href="<?= WHATSAPP ?>">
