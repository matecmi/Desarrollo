				...
				<div class="col-md-6 col-lg-5 p-b-30">
					<div class="p-r-50 p-t-5 p-lr-0-lg">
						...
						<?php if($arrProducto['stock'] != 0){   ?>
							...
							<?php 
								if(!empty($data['productocondesc']["nuevo_total"])){
							?>
								<span class="mtext-106 cl2" style="font-size: 30px;">
									<?= SMONEY.formatMoney($data['productocondesc']["nuevo_total"]); ?>
								</span>
								<span> - </span>
								<span class="mtext-106 cl2" style="text-decoration: line-through;color: #cd0008;font-size: 30px;">
									<?= SMONEY.formatMoney($arrProducto['precio']); ?>
								</span>
								<span style="background: hsl(152, 51%, 52%);font-size: 0.813rem;color: #ffffff;border-radius: 5px;padding: 3px 5px;"><b class="descuentototal"><?= $data['productocondesc']["descuento"]; ?></b>%</span>
							<?php
								}else{
							?>
								<span class="mtext-106 cl2" style="font-size: 30px;">
						...
						<?php  }else{  ?>
							...
							<span class="mtext-106 cl2" style="text-decoration: line-through;color: #cd0008;">
								<?= SMONEY.formatMoney($arrProducto['precio']); ?>
							</span>
						...
						<!--  -->
							...
							<?php  }else{  ?>
								<h4 style="font-weight: 600;color: #cd0008;" class="stext-101 cl2 hov-cl1 trans-04 m-tb-10"><i class="fa fa-frown-o" aria-hidden="true"></i> Producto agotado </h4>
							<?php  }  ?>
						<!--  -->
