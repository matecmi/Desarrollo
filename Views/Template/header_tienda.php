...
$dominio = $_SERVER['HTTP_HOST']; // Obtiene el nombre del dominio
$currentPage = $_SERVER['REQUEST_URI']; // Obtiene la parte de la URL después del nombre de dominio
		...
		<div class="container-menu-desktop">
			...
			<div class="wrap-menu-desktop" style="top: 0px;">
				<nav class="limiter-menu-desktop container">
					...
					<!-- Logo desktop -->
					<a href="<?= base_url(); ?>" class="logo" style="height:75px">
					...
					<div class="menu-desktop">
						<ul class="main-menu">
							<li>
								<a id="linkInicio" href="<?= base_url(); ?>">Inicio</a>
							</li>

							<li>
								<a id="linkTienda" href="<?= base_url(); ?>/tienda">Tienda</a>
							</li>
							<!-- 
							 <li>
								<a href="<?= base_url(); ?>/catalogo/bijou/1">Catálogo</a>
							</li> 

							<li>
								<a href="<?= base_url(); ?>/landing">Landing Pages</a>
							</li>
							-->
							<li>
								<a id="linkNosotros" href="<?= base_url(); ?>/nosotros">Nosotros</a>
							</li>
