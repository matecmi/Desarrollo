    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li class="treeview">
            ...
            <ul class="treeview-menu">
                ...
                <?php if(!empty($_SESSION['permisos'][13]['r'])){ ?>
                    <li><a class="treeview-item" href="<?= base_url(); ?>/envios"><i class="icon fa fa-circle-o"></i> Precio Envíos</a></li>
                <?php } ?>
            </ul>
        </li>
        <?php } ?>
        ...
        <?php if(!empty($_SESSION['permisos'][11]['r']) || !empty($_SESSION['permisos'][14]['r'])){ ?>
            <li class="treeview">
                <a class="app-menu__item" href="#" data-toggle="treeview">
                    <i class="app-menu__icon fa fa-archive" aria-hidden="true"></i>
                    <span class="app-menu__label">Landing</span>
                    <i class="treeview-indicator fa fa-angle-right"></i>
                </a>
                <ul class="treeview-menu">
                    <?php if(!empty($_SESSION['permisos'][11]['r'])){ ?>
                    <li><a class="treeview-item" href="<?= base_url(); ?>/landingpages"><i class="icon fa fa-circle-o"></i> Landing Pages</a></li>
                    <?php } ?>

                    <?php if(!empty($_SESSION['permisos'][14]['r'])){ ?>
                    <li><a class="treeview-item" href="<?= base_url(); ?>/landingreportes"><i class="icon fa fa-circle-o"></i> Reportes</a></li>
                    <?php } ?>
        ...
        <li>
            <a class="app-menu__item" href="<?= base_url(); ?>/catalogos">
                <i class="app-menu__icon fa fa-file-image-o" aria-hidden="true"></i>
